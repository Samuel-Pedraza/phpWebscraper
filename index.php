...
$app->get('/', function ($request, $response, $args) {
    return $this->renderer->render($response, "/webScraper/templates/home.php", $args);
});
...
$app->post('/vestil', function($request, $response, $args){
    ...
    //
    // $vestilWebscrapers->hofequipment("http://hofequipment.com/cart.php?m=search_results&catID=&venID=1&search=&shopByPrice=&sortBy=&viewAll=1", "hofequipment", "vestil", mysqli_connect('', '', '', 'sams_test_database'));
    // echo "hofequipment finished";
    //
    // $vestilWebscrapers->industrialsafety("https://industrialsafety.com/catalogsearch/result/index/?p=1&product_list_limit=80&q=vestil", "industrialsafety", 14, "vestil", mysqli_connect('', '', '', 'sams_test_database'));
    // echo "industrialsafety finished";
    //
    // $vestilWebscrapers->toolfetch("https://www.toolfetch.com/by-brand/vestil/l/brand:vestil.html?limit=48&p=1", "toolfetch", 172, "vestil", mysqli_connect('', '', '', 'sams_test_database'));
    // echo "toolfetch finished";
    //
    // $vestilWebscrapers->opentip("https://www.opentip.com/search.php?brand=35098&keywords=vestil&page=1", "opentip", 305,"vestil", mysqli_connect('', '', '', 'sams_test_database'));
    // echo "opentip finished";
    //
    // $vestilWebscrapers->globalindustrial("http://www.globalindustrial.com/shopByBrandName/V/vestil-manufacturing?cp=1&ps=72", "globalindustrial", 34,"vestil", mysqli_connect('', '', '', 'sams_test_database'));
    // echo "globalindustrial finished";
    //
    // $vestilWebscrapers->source4industries("https://source4industries.com/index.php?route=product/search&search=vestil", "source4industries", "vestil", mysqli_connect('', '', '', 'sams_test_database'));
    // echo "source4industries finished";
    //
    // $vestilWebscrapers->spill911("https://www.spill911.com/mm5/merchant.mvc?Screen=SRCH2&Store_Code=spill911&search=vestil&searchoffset=0&Category_Code=&filter_cat=&PowerSearch_Begin_Only=&sort=&range_low=&range_hig=&customfield1=brand&filter_cf1=&customfield2=&filter_cf2=&customfield3=&filter_cf3=&psboost=srchkeys%2Ccode%2Cname&filter_price=&priceranges=1", "spill911", "vestil", mysqli_connect('', '', '', 'sams_test_database'));
    // echo "spill911 finished";

    $vestilWebscrapers->custommhs("https://www.custommhs.com/index.php?route=product/manufacturer&manufacturer_id=42&page=1", "custommhs", 1, "vestil", mysqli_connect('', '', '', 'sams_test_database'));
    echo "custommhs finished";

    $vestilWebscrapers->sodyinc("http://www.sodyinc.com/index.php?main_page=index&manufacturers_id=2&sort=20a&page=1", "sodyinc", 13, "vestil", mysqli_connect('', '', '', 'sams_test_database'));
