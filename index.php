...
$app->post('/vestil', function($request, $response, $args){
    ...
    //
    // $vestilWebscrapers->hofequipment("http://hofequipment.com/cart.php?m=search_results&catID=&venID=1&search=&shopByPrice=&sortBy=&viewAll=1", "hofequipment", "vestil", mysqli_connect('66.112.76.254', 'root', 'adamserver5', 'sams_test_database'));
    // echo "hofequipment finished";
    //
    // $vestilWebscrapers->industrialsafety("https://industrialsafety.com/catalogsearch/result/index/?p=1&product_list_limit=80&q=vestil", "industrialsafety", 14, "vestil", mysqli_connect('66.112.76.254', 'root', 'adamserver5', 'sams_test_database'));
    ...
    //
    // $vestilWebscrapers->spill911("https://www.spill911.com/mm5/merchant.mvc?Screen=SRCH2&Store_Code=spill911&search=vestil&searchoffset=0&Category_Code=&filter_cat=&PowerSearch_Begin_Only=&sort=&range_low=&range_hig=&customfield1=brand&filter_cf1=&customfield2=&filter_cf2=&customfield3=&filter_cf3=&psboost=srchkeys%2Ccode%2Cname&filter_price=&priceranges=1", "spill911", "vestil", mysqli_connect('66.112.76.254', 'root', 'adamserver5', 'sams_test_database'));
    // echo "spill911 finished";
    //
    // $vestilWebscrapers->custommhs("https://www.custommhs.com/index.php?route=product/manufacturer&manufacturer_id=42&page=1", "custommhs", 1, "vestil", mysqli_connect('66.112.76.254', 'root', 'adamserver5', 'sams_test_database'));
    // echo "custommhs finished";
    //
    // $vestilWebscrapers->sodyinc("http://www.sodyinc.com/index.php?main_page=index&manufacturers_id=2&sort=20a&page=1", "sodyinc", 13, "vestil", mysqli_connect('66.112.76.254', 'root', 'adamserver5', 'sams_test_database'));
